...
from dogia.cmds.configure import configure_cmd
from dogia.cmds.farm import farm_cmd
from dogia.cmds.init import init_cmd
from dogia.cmds.keys import keys_cmd
from dogia.cmds.netspace import netspace_cmd
from dogia.cmds.plots import plots_cmd
from dogia.cmds.show import show_cmd
from dogia.cmds.start import start_cmd
from dogia.cmds.stop import stop_cmd
from dogia.cmds.wallet import wallet_cmd
from dogia.cmds.plotnft import plotnft_cmd
...
@click.group(
    help=f"\n  Manage dogia blockchain infrastructure ({__version__})\n",
    epilog="Try 'dogia start node', 'dogia netspace -d 192', or 'dogia show -s'",
...
@cli.command("version", short_help="Show dogia version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs dogia daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from dogia.daemon.server import async_run_daemon
    import asyncio
