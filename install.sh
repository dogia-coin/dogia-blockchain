...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The Dogia Blockchain requires a 64 bit OS and this is 32 bit armv7l"
	echo "For more information, see"
	echo "https://github.com/Dogia-Network/dogia-blockchain/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
# Get submodules
...
python -m pip install --extra-index-url https://pypi.dogia.net/simple/ miniupnpc==2.2.2
python -m pip install -e . --extra-index-url https://pypi.dogia.net/simple/

echo ""
echo "Dogia blockchain install.sh complete."
echo "For assistance join us on Keybase in the #testnet chat channel:"
echo "https://keybase.io/team/dogia_network.public"
echo ""
echo "Try the Quick Start Guide to running dogia-blockchain:"
echo "https://github.com/Dogia-Network/dogia-blockchain/wiki/Quick-Start-Guide"
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'dogia init' to begin."
