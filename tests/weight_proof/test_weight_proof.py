...
from dogia.server.start_full_node import SERVICE_NAME
...
from dogia.consensus.pot_iterations import calculate_iterations_quality
from dogia.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
