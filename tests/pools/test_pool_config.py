...
from dogia.pools.pool_config import PoolWalletConfig
from dogia.util.config import load_config, save_config, create_default_dogia_config
...
def test_pool_config():
    ...
    create_default_dogia_config(test_root, ["config.yaml"])
