...
from dogia.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "dogia" in cc_discrepancies:
                    cc_discrepancies["dogia"] = cc_discrepancies["dogia"] + diff
                else:
                    cc_discrepancies["dogia"] = diff
