...
from dogia.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "beta1_introducer.dogia.net"
            testnet = "testnet7"
            ...
            mainnet_port = "8444"
            mainnet_introducer = "introducer.dogia.net"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running dogia services for changes to take effect")
