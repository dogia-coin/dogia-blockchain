...
from dogiavdf import create_discriminant

from dogia.consensus.constants import ConsensusConstants
from dogia.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from dogia.timelord.iters_from_block import iters_from_block
from dogia.timelord.timelord_state import LastState
from dogia.timelord.types import Chain, IterationType, StateType
from dogia.types.blockchain_format.classgroup import ClassgroupElement
from dogia.types.blockchain_format.reward_chain_block import RewardChainBlock
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[DogiaServer] = None
