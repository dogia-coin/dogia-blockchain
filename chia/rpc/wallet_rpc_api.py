...
from dogia.cmds.init_funcs import check_keys
from dogia.consensus.block_rewards import calculate_base_farmer_reward
from dogia.pools.pool_wallet import PoolWallet
from dogia.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
...
from dogia.simulator.simulator_protocol import FarmNewBlockProtocol
from dogia.types.blockchain_format.coin import Coin
from dogia.types.blockchain_format.sized_bytes import bytes32
from dogia.util.bech32m import decode_puzzle_hash, encode_puzzle_hash
from dogia.util.byte_types import hexstr_to_bytes
from dogia.util.ints import uint32, uint64
from dogia.util.keychain import bytes_to_mnemonic, generate_mnemonic
from dogia.util.path import path_from_root
from dogia.util.ws_message import WsRpcMessage, create_payload_dict
from dogia.wallet.cc_wallet.cc_wallet import CCWallet
from dogia.wallet.derive_keys import master_sk_to_singleton_owner_sk
from dogia.wallet.rl_wallet.rl_wallet import RLWallet
from dogia.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
...
from dogia.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from dogia.wallet.util.trade_utils import trade_record_to_dict
from dogia.wallet.util.transaction_type import TransactionType
from dogia.wallet.util.wallet_types import WalletType
from dogia.wallet.wallet_info import WalletInfo
from dogia.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "dogia_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "dogia_wallet", "wallet_ui")]
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from dogia.pools.pool_wallet_info import initial_pool_state_from_dict
